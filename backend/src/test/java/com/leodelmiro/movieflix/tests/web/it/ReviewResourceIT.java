...
public class ReviewResourceIT {
	...
	void setUp() throws Exception {
		...
		visitorUsername = "nelio@gmail.com";
		visitorPassword = "123456";
		memberUsername = "leonardo@gmail.com";
